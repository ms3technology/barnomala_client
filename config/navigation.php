...
return [
    'navigation_items' => [
        ...
        ['label' => 'Academic', 'route' => 'academic.index', 'children' => [
            ['label' => 'Academic Calendar', 'route' => 'home'],
            ['label' => 'Academic Rules', 'route' => 'home'],
            ['label' => 'Class Schedule', 'route' => 'home'],
            ['label' => 'Teachers', 'route' => 'home'],
            ['label' => 'Former Teachers', 'route' => 'home'],
        ...
        ['label' => 'Student', 'route' => 'teachers.index', 'children' => [
            ['label' => 'Tution Fees', 'route' => 'home'],
            ['label' => 'Our Student', 'route' => 'home'],
            ['label' => 'Student Uniform', 'route' => 'home'],
            ['label' => 'Exam Schedule', 'route' => 'home'],
