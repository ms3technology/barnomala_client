...
<section class="py-16">
    <div class="mx-auto max-w-[90%] px-4 sm:px-6 lg:px-8">
        <div>
            <p class="text-sm font-semibold uppercase tracking-[0.35em] text-slate-500">Support Team</p>
            <h1 class="mt-4 text-4xl font-black text-slate-950">Our Dedicated Staff</h1>
            ...
            <div class="mt-12">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
                    ...
                    <div class="col-span-full py-20 text-center bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
                        ...
                        <p class="text-slate-400 font-bold">No staff members recorded yet.</p>
                    </div>
                    @endforelse
                </div>
            </div>
