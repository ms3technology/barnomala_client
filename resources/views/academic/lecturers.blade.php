    ...
    <div class="mx-auto max-w-[90%] px-4 sm:px-6 lg:px-8">
        <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-6 gap-8">
                    ...
                    <div class="group relative flex flex-col overflow-hidden rounded-2xl bg-slate-50 border border-slate-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div class="flex flex-1 flex-col p-2">
                            ...
                            <p class="text-xs font-bold text-accent uppercase tracking-wider mt-1">{{ $teacher->designation }}</p>
                            @if($teacher->department)
                                <p class="text-xs font-semibold text-slate-500 mt-2">{{ $teacher->department }}</p>
                            @endif
                        </div>
                    </div>
                    @empty
            ...
            <div class="mt-16 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ route('teachers.index') }}" class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-bold text-slate-700 shadow-sm transition-all duration-300 hover:border-accent hover:text-accent hover:shadow-md">
