@if(isset($notices) && count($notices) > 0)
    <div class="relative z-40 mt-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center font-bn">
            ...
            <div class="flex-1 overflow-hidden ml-0 sm:-ml-2 bg-indigo-900/50 rounded-r-lg sm:rounded-r-full border border-indigo-500/30 shadow-inner py-1.5 px-4 h-full flex items-center relative z-0">
