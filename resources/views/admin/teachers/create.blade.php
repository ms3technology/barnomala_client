...
<div class="mb-6 flex items-center justify-between">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Add Teacher</h2>
            <p class="text-sm text-slate-500 mt-1 uppercase tracking-wider font-semibold">Faculty Information</p>
        </div>
    </div>
</div>
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="designation" value="{{ old('designation') }}" required placeholder="e.g. Assistant Teacher"
                                   class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none font-medium text-slate-800">
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="teacher_code" value="{{ old('teacher_code') }}"
                                   class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none font-medium text-slate-800">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-6 py-3">
                                <label class="flex items-center gap-2 cursor-pointer group">
                                    <input type="radio" name="status" value="1" checked class="w-5 h-5 text-emerald-500 focus:ring-emerald-500/20">
                                    <span class="text-sm font-bold text-slate-600 group-hover:text-emerald-600">Active</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer group">
                                    <input type="radio" name="status" value="0" class="w-5 h-5 text-slate-400 focus:ring-slate-500/20 border-slate-300">
                ...
                <div class="p-6">
                    <div id="image-dropzone" class="relative group cursor-pointer">
                        ...
                        <div class="w-full aspect-square md:aspect-auto md:h-60 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 flex flex-col items-center justify-center gap-4 transition-all hover:bg-indigo-50 hover:border-indigo-200 group-hover:border-indigo-300" 
                             ...
                             tabindex="0">
                            <div id="preview-container" class="hidden absolute inset-0 rounded-xl bg-white overflow-hidden pointer-events-none">
                            ...
                            <div id="upload-prompt" class="flex flex-col items-center gap-3">
                                ...
                                <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Upload Portrait</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="p-6 space-y-4">
                    <div class="space-y-2">
                        ...
                        <input type="number" name="priority_index" value="{{ old('priority_index', 0) }}" required
