...
@push('header_actions') <a href="{{ route('admin.posts.create') }}"
    class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white text-sm font-semibold
           shadow-sm hover:bg-slate-800 hover:-translate-y-0.5 transition-all duration-200"> <i class="fas fa-plus text-xs"></i>
New Post </a>
@endpush
...
<div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="flex gap-1.5 overflow-x-auto p-3 scrollbar-hide">
        ...
        <table class="w-full text-left">
            ...
            <thead>
                <tr class="bg-slate-50/70 border-b border-slate-100">
                    <th class="px-6 py-3.5 text-[10px] uppercase tracking-[0.12em] font-bold text-slate-400">
                        Post
                    </th>

                    <th class="px-5 py-3.5 text-[10px] uppercase tracking-[0.12em] font-bold text-slate-400">
                        Type
                    </th>
                    ...
                    <th class="px-6 py-3.5 text-right text-[10px] uppercase tracking-[0.12em] font-bold text-slate-400">
                        Action
                    </th>
                </tr>
            </thead>
                            ...
                            <div class="flex items-center gap-4 min-w-[280px]">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <p class="post-title font-semibold text-slate-800 truncate max-w-[340px]">
                                            {{ $post->title }}
                                        </p>
