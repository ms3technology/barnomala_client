                ...
                <div class="p-4 space-y-6">
                    ...
                    <div x-show="isDownload" x-cloak class="space-y-6">
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5" class="block w-full px-4 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-slate-800 shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">{{ old('description', $post->description) }}</textarea>
                        </div>
