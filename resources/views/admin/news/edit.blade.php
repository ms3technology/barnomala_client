...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.news.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-bold">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3 space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="summary" id="summary" rows="2" 
                                  ...
                                  placeholder="Short preview...">{{ old('summary', $news->summary) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="8" 
                                  class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-accent focus:ring-2 focus:ring-accent/30 transition-all text-sm" 
                                  placeholder="Write news article..." required>{{ old('content', $news->content) }}</textarea>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="mb-4 space-y-2">
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 flex items-center justify-between group hover:border-accent/30 transition-all">
                        <div class="flex items-center gap-2 overflow-hidden">
                            <div class="w-8 h-8 bg-white rounded flex items-center justify-center text-accent text-xs">
                                <i class="fas fa-file-alt"></i>
                            </div>
                            <div class="overflow-hidden">
                                <p class="text-xs font-bold text-gray-900 truncate">{{ $artifact->file_name }}</p>
                                <p class="text-[10px] text-gray-400 font-bold uppercase">{{ round($artifact->file_size / 1024, 1) }} KB</p>
                            </div>
                        </div>
                        <label class="flex items-center cursor-pointer p-1.5 bg-red-50 text-red-600 rounded hover:bg-red-600 hover:text-white transition-all">
                ...
                <div class="space-y-2 pt-2 border-t border-gray-50">
                    <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1">Add Files</label>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                @if($news->image_json)
                <div class="mb-3 aspect-video rounded-lg overflow-hidden border border-gray-100">
