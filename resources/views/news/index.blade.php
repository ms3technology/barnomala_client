                ...
                @forelse ($news as $item)
                    <article class="flex flex-col rounded-3xl overflow-hidden border border-slate-100 bg-slate-50 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-2 group">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('news.show', $item) }}" class="inline-flex items-center gap-2 text-sm font-black text-accent uppercase tracking-widest group/btn border-b-2 border-transparent hover:border-accent transition-all pb-1">
                                    Read Full Story
