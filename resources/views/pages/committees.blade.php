...
@section('content')
<section class="py-6">
    <div class="mx-auto md:max-w-[70%] px-4 md:px-8 space-y-16">
        @forelse($committees as $committee)
            <div>
                <h1 class="mt-4 text-4xl font-black text-slate-950">{{ $committee->name }}</h1>
                ...
                <div class="mt-8 space-y-8">
                        ...
                        <div class="flex flex-1 flex-col p-6">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-slate-500 mt-1">{{ $committee->name }} <span class="text-slate-400">·</span> {{ $committee->session }}</p>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="py-12 text-center bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
                            <i class="fas fa-user-friends text-slate-200 text-5xl mb-4"></i>
                            <p class="text-slate-400 font-bold">No members recorded for this committee yet.</p>
                        </div>
                    @endforelse
                </div>
            </div>
